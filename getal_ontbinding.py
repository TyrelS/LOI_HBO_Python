...
# waarna het wordt ontbonden in een product van priemgetallen
...
def getalOntbinden(n): # Hier wordt een functie aangemaakt voor de ontbinding van het getal
    factoren = [] # Er wordt een lijst aangemaakt voor de priemfactoren
    deler = 2 # Een variabele voor de 'deler' wordt aangemaakt en toegewezen met 2

    while n > 1: # Met een while loop wordt gekeken of het nummer groter is dan 1
        while n % deler == 0: # Vervolgens wordt met de tweede while loop gekeken of de rest na deling van het getal 'n' door de 'deler' gelijk is aan 0
